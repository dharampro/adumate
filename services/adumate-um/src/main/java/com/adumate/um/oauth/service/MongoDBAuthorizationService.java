package com.adumate.um.oauth.service;

import com.adumate.um.oauth.domain.MongoDBAuthorization;
import com.adumate.um.oauth.repository.AuthorizationRepository;
...
public class MongoDBAuthorizationService implements OAuth2AuthorizationService {
    private final AuthorizationRepository authorizationRepository;
    private final RegisteredClientRepository registeredClientRepository;
    private final ObjectMapper objectMapper = new ObjectMapper();

    public MongoDBAuthorizationService(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
        this.authorizationRepository = authorizationRepository;
        this.registeredClientRepository = registeredClientRepository;

        ClassLoader classLoader = MongoDBAuthorizationService.class.getClassLoader();
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        ...
        Optional<MongoDBAuthorization> result;
        if (tokenType == null) {
    ...
    private OAuth2Authorization toObject(MongoDBAuthorization entity) {
    ...
    private MongoDBAuthorization toEntity(OAuth2Authorization authorization) {
        MongoDBAuthorization entity = new MongoDBAuthorization();
